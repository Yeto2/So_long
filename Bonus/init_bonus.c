...
/*   Updated: 2024/02/09 22:13:45 by yessemna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	destroy_images(t_img *img, t_data *data)
{
	...
	mlx_destroy_image(data->mlx_ptr, img->enemy_ptr);
}
...
void	init_img(t_img *img, t_data *data)
{
	...
	img->enemy_ptr = is_valid(data, "Mandatory/img/enemy.xpm", 7);
	data->tab_imgs[7] = img->enemy_ptr;
}
